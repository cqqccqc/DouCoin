  ...
  <body>
        ...
        <?php if (isset($_SESSION['uid'])){?>
          <form class="navbar-form navbar-right" action="<?=base_url().'index.php/login/logout' ?>" method="post" >
            <div class="form-group">
              <a href="<?=base_url().'index.php/user/index/'?>" class="form-control"><?=$_SESSION['email']?></a>
            </div>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>在这里你可以操作各类电子货币。</p>
        <p>
        <?php if (isset($_SESSION['uid'])){echo '<a href="'.base_url().'index.php/user/index/" class="btn btn-success btn-lg">'.$_SESSION['email'].'的个人中心';}
        	else echo '<a href="index.php/register" class="btn btn-success btn-lg">注册 &raquo;'?>
        </a></p>
      </div>
    </div>
